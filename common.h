...
#define logformat_nonl(format, ...) "%s:%d (%s) " format,  __FILE__, __LINE__, __func__ __VA_OPT__(,) __VA_ARGS__
...
const struct in_addr ANY_ADDR4 = {.s_addr = HTON_IP(0, 0, 0, 0)};
...
const struct in_addr ANY_ADDR = ANY_ADDR4;
#endif
